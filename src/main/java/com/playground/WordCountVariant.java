 ...
 * Usage hadoop jar pro-hadoop.jar com.playground.WordCountVariant <inputHdfsPath> <otputHdfsPath>
 * if the outputHdfs path exists we delete it and then run the program
 *
 */


public class WordCountVariant {
	...
	public static void main(String[] args) throws Exception {
		...
		//if output path exists delete it to avoid an exception
